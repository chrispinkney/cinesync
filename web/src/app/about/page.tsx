			...
			<Grid container direction="column" alignItems="center">
				<Grid item>
					...
					<p>
						...
						have the power to bring people closer, spark conversations, and
						offer a unique form of entertainment. CineSync serves as the bridge
						that connects your passion for movies with the people who share that
						passion.
					</p>
					<p>
						Join us on this cinematic journey, and let CineSync enhance your
						love for movies, making every film-watching experience a shared
						adventure.
					</p>
					<h2>Features</h2>
					<p>
					...
					<ul>
						<li>
							...
							list, &quot;Watched&quot; list, or any other personalized
							category, you can create and manage them with ease. You have the
							flexibility to keep your lists private or share them with selected
							friends or groups.
						</li>
						<li>
							<strong>Discover Movies:</strong> Search and add movies from a
							vast database, complete with details such as titles, descriptions,
							genres, release years, and more. This feature makes it convenient
							to keep track of your favorite movies or plan your future
							watchlist.
						</li>
						<li>
						...
						<li>
							<strong>Rate and Review:</strong> Share your thoughts on the
							movies you&apos;ve watched by providing ratings and reviews,
							contributing to the collective knowledge of the CineSync
							community.
						</li>
						<li>
							<strong>Responsive Design:</strong> Whether you&apos;re on a
							desktop, tablet, or mobile device, CineSync&apos;s responsive
							design guarantees a consistent and user-friendly experience.
						</li>
						<li>
